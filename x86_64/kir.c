...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kir /home/marko/magy/thesis/sim/kir.mod\n");
...
static int  rate (  double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 33.0 ) / 10.0 ) ) ;
   linf = 1.0 / ( 1.0 + exp ( ( _lv - vhalfl - sh ) / kl ) ) ;
   taul = factor * 1.0 / ( _lqt * ( at * exp ( - _lv / vhalft ) + bt * exp ( _lv / vhalft ) ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/marko/magy/thesis/sim/kir.mod";
static const char* nmodl_file_text = 
  "	\n"
  "\n"
  ...
  "        RANGE  ik, gkbar, vhalfl, kl, vhalft, at, bt, q10, gk, sh \n"
  "        GLOBAL linf,taul\n"
  "}\n"
  "\n"
  "\n"
  ...
  "        linf = 1/(1 + exp((v-vhalfl-sh)/kl))			: l_steadystate\n"
  " 	taul = factor*1/(qt *(at*exp(-v/vhalft) + bt*exp(v/vhalft) ))	\n"
  "}\n"
  "\n"
  "\n"
  "\n"
