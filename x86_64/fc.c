...
extern "C" {
 ...
 static void _hoc_gfloor(void);
 static void _hoc_gceil(void);
...
extern Memb_func* memb_func;
 ...
 "setdata_fc", _hoc_setdata,
 "gfloor", _hoc_gfloor,
 "gceil", _hoc_gceil,
 0, 0
};
 extern double gfloor( double );
 extern double gceil( double );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _fc_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 fc /home/marko/magy/thesis/sim/fc.mod\n");
 }
static int _reset;
