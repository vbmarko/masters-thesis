...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na3 /home/marko/magy/thesis/sim/na3n.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/marko/magy/thesis/sim/na3n.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
  ...
  "	gbar = 0.010   	(mho/cm2)	\n"
  "								\n"
  "	tha  =  -30	(mV)		: v 1/2 for act	-38 (Hyun)\n"
  "	qa   = 7.2	(mV)		: act slope (4.5) 8 -Hyun		\n"
  "	Ra   = 0.4	(/ms)		: open (v)		0.182 (Hyun)\n"
  "	Rb   = 0.124 	(/ms)		: close (v)		\n"
  "\n"
