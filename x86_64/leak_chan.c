...
#define dt _nt->_dt
#define g_pas _p[0]
#define g_pas_columnindex 0
#define e_pas _p[1]
#define e_pas_columnindex 1
#define i _p[2]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 leak /home/marko/magy/thesis/sim/leak_chan.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "A simple passive channel";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/marko/magy/thesis/sim/leak_chan.mod";
static const char* nmodl_file_text = 
