...
#define gkabar _p[1]
#define gkabar_columnindex 1
#define ik _p[2]
#define ik_columnindex 2
#define gka _p[3]
#define gka_columnindex 3
#define n _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kap /home/marko/magy/thesis/sim/kaprox.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/marko/magy/thesis/sim/kaprox.mod";
static const char* nmodl_file_text = 
